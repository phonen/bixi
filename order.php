...
//break;
/*
	$content1 = file_get_contents("http://192.168.1.88/xh/json.php?code=cl1000xh");//得到文件执行的结果
	$of1 = fopen('xh/you.txt','w');//创建并打开dir.txt
	if($content1){
	 fwrite($of1,$content1);//把执行文件的结果写入txt文件
	}
	...
	$content2 = file_get_contents("http://192.168.1.88/xh/json.php?code=ag50kgxh");//得到文件执行的结果
	...
	$content3 = file_get_contents("http://192.168.1.88/xh/json.php?code=cu10txh");//得到文件执行的结果
