...
$input->SetNotify_url("http://www.caomengde.cn/Extend/weipay/native_notify.php");
...
<head>
	...
	function successjs()
	{
		 ...
		 $.post("http://www.caomengde.cn/index.php/Home/User/notify2", {"order_id":"<?php echo $_REQUEST['order_id'] ?>"}, function (ret) {	
		     //alert(ret);			
		 	if(ret == 2)
		 	{
		 		alert('充值成功');
